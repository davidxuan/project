...
public class AcdcWithSmellDetection {
	...
	public static void main(String[] args) throws IOException {
		...
		// inputDirName is a directory where each subdirectory contains a revision or
		// version of the system to be analyzed
	...
	public static void single(File versionFolder, String[] args, File outputDir)
		...
		// the revision number is really just the name of the subdirectory, for hadoop I
		// actually name each subdirectory based on the revision number
		String revisionNumber = versionFolder.getName();

		// classesDir is the directory in each subdirectory of the dir directory that
		// contains the compiled classes of the subdirectory
		...
		// depsRsfFilename is the file name of the dependencies rsf file (one is created
		// per subdirectory of dir)
		...
		// subdirectory of dir
		String acdcClusteredFile = outputDir.getAbsolutePath() + File.separatorChar + revisionNumber
				+ "_acdc_clustered.rsf";
		...
		String[] smellArgs = { depsRsfFile.getAbsolutePath(), acdcClusteredFile,
				outputDir.getAbsolutePath() + File.separatorChar + revisionNumber + "_acdc_smells.ser" };
